...
That is to say - _**Language mirrors Reality**_ - the consequence of which is that if we can analyze language through its _syntax/grammar_ and _semantics/meaning_, we can analyze **R**eality. To Summarize,
